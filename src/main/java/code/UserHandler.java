...
public class UserHandler implements HttpHandler {
    ...
    private static final String ERROR_MESSAGE = "[ERROR] -USER(HANDLER)";
    ...
    public void handle(HttpExchange exchange) {
        ...
        try (exchange) {
            switch (method) {
                ...
                default -> errorResponse(exchange, 405, ERROR_MESSAGE + ": Unsupported user method\n");
            }
        }
    ...
    */
    ...
    private void postRequest(HttpExchange exchange, Headers headers) throws IOException {
        ...
        // Invalid format for user
            ...
            errorResponse(exchange, 401, ERROR_MESSAGE + e.getMessage());
        }
        ...
        // No content type found
            ...
            errorResponse(exchange, 405, ERROR_MESSAGE + e.getMessage());
        }
        ...
        // Catch unexcepted errors
            ...
            errorResponse(exchange, 418, ERROR_MESSAGE + e.getMessage());
        }
